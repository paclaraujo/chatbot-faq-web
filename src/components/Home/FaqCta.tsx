      ...
      <div className="mx-auto w-full max-w-350 px-4 sm:px-6">
        <div className="grid gap-8 rounded-3xl border border-border bg-card p-6 shadow-soft sm:p-8 lg:grid-cols-[1fr_auto] lg:items-center lg:gap-12">
          <div className="flex items-start gap-4">
            <div>
              <h2 className="text-lg font-bold text-foreground">Ficou com dúvidas?</h2>
              <p className="mt-1 max-w-sm text-sm text-muted-foreground">
                Pergunte ao nosso assistente e encontre respostas para as dúvidas mais comuns
                sobre a Capa de Invisibilidade.
              </p>
              <button
                type="button"
                onClick={openChat}
